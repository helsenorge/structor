...
export const getResources = (language: string): Resources => {
  if (language === "en-GB") {
    return {
      ...
      filterDateErrorBeforeMinDate:
        "From date can not be earlier than before date",
  ...
  if (language === "fr-FR") {
    return {
      ...
      dateRequired:
        "Sélectionnez une date, ou entrez la date comme suit: jj.mm.aaaa.",
      ...
      filterDateErrorBeforeMinDate:
        "La date ne peut pas être une date située avant la date minimale",
      filterDateErrorAfterMaxDate:
        "La date ne peut pas être une date située après la date maximale",
      ...
      moveFocustoStartAndEndOfWeek:
        "Aller au premier ou dernier jour de la semaine",
