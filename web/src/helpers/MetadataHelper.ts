...
export const presentationButtons = [
  {
    code: "sticky",
    display: "Floating at the bottom of the screen (standard setting)",
  },
...
export const skjemaUtfyllerOptions = [
  {
    code: skjemaUtfyllerCode.Standard,
    display: skjemaUtfyllerDisplay.Standard,
  },
  {
    code: skjemaUtfyllerCode.Tilpasset,
    display: skjemaUtfyllerDisplay.Tilpasset,
  },
];
