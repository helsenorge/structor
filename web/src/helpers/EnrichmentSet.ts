...
const EnrichmentSet: Array<EnrichmentExpessionMetadata> = [
  ...
  },
  {
    ...
    expression:
      "Practitioner.name.where(use = 'official').select(given.join(' ') & ' ' & family)",
  ...
  },
  {
    ...
    expression:
      "Practitioner.contained.first().telecom.where(use = 'work' and system = 'phone').value",
    group: "General Practitioner",
    type: "string",
  },
  {
    ...
    expression:
      "Practitioner.contained.first().address.where(use = 'work').line.first()",
    group: "General Practitioner",
    type: "string",
  },
  {
    ...
    expression:
      "Practitioner.contained.first().address.where(use = 'work').line.skip(1).first()",
    group: "General Practitioner",
    type: "string",
  },
  {
    ...
    expression:
      "Practitioner.contained.first().address.where(use = 'work').line.skip(2).first()",
    group: "General Practitioner",
    type: "string",
  },
  {
    ...
    expression:
      "Practitioner.contained.first().address.where(use = 'work').postalCode",
    group: "General Practitioner",
    type: "string",
  },
  {
    ...
    expression:
      "Practitioner.contained.first().address.where(use = 'work').city",
    group: "General Practitioner",
    type: "string",
  },
  {
    ...
    expression:
      "Practitioner.contained.first().address.where(use = 'work').country",
    group: "General Practitioner",
    type: "string",
  },
  {
  ...
  },
  {
    ...
    expression:
      "iif(%representative.relationship.coding.where(system = 'urn:oid:2.16.578.1.12.4.1.1.7611').code = 'FO','Foreldreansvar',iif(%representative.relationship.coding.where(system = 'urn:oid:2.16.578.1.12.4.1.1.7611').code = 'FU','Fullmakt',iif(%representative.relationship.coding.where(system = 'urn:oid:2.16.578.1.12.4.1.1.7611').code = 'TD','Tildelt fullmakt','')))",
    group: "Representative relation",
    type: "string",
  },
  {
