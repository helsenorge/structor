...
const CalculatedExpressionOption = (props: CalculatedExpressionOptionProps): React.JSX.Element => {
    ...
    const calculatedExpression =
        props.item.extension?.find((ext) => ext.url === IExtensionType.calculatedExpression)?.valueString || '';
    return (
