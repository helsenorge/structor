  ...
  const setCalculationExpression = (code: string | undefined) => {
      if (code) {
          const calculatedExpression =
              getExtensionStringValue(props.getItem(code), IExtensionType.calculatedExpression) ?? '';
          if (calculatedExpression) {
              ...
              removeItemExtension(props.item, IExtensionType.calculatedExpression, dispatch);
          }
      }
  };
