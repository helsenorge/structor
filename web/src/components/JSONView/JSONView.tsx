...
const JSONView = ({ showJSONView }: Props): React.JSX.Element => {
    ...
    const handleCopy = async () => {
        const content = JSON.stringify(JSON.parse(generateQuestionnaire(state)), null, 2)
            ...
            <div className="structor-helper">
                <div className="title">
                    ...
                    <div className="copyWrapper">
                        <IconBtn position='right'  color='white' size="large" type={isCopied ? 'check' : 'copy'} title={t('copyButton')} onClick={handleCopy} />
                    </div>
