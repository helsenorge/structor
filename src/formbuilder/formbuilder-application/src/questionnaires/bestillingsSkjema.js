export const bestillingsSkjema = {
  ...
  extension: [
    {
      ...
      valueReference: {
        reference:
          "https://skjemakatalog-test-fhir-apimgmt.azure-api.net/api/v1/Endpoint/2",
      },
    },
    {
      url:
  ...
  url:
    "https://skjemakatalog-test-fhir-apimgmt.azure-api.net/api/v1/Questionnaire/50",
  version: "1",
  name: "HV-BHM-INR-1",
  ...
  description:
    "Bestillingsskjema for forbruksmateriell til egenkontroll av INR",
  useContext: [
    {
      code: {
              ...
              extension: [
                {
                  url:
                    "http://ehelse.no/fhir/StructureDefinition/validationtext",
                  valueString:
                    "Du må fylle ut dette feltet. Kun 4 heltall er lovlig.",
                },
                {
        ...
        },
        {
          ...
          item: [
            ...
            },
            {
              linkId: "4.4.3",
              text:
                "Helse Bergen, Solheimsgaten 13A, (Motorhallen), 5058  Bergen",
              _text: {
                extension: [
                  {
                    url:
