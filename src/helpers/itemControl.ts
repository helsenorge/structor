...
export const isItemControlDataReciever = (item: QuestionnaireItem): boolean => {
    return existItemControlWithCode(item, ItemControlType.dataReciever);
};
