export const koronaSkjema = {
        ...
        "include": [
          {
            ...
            "concept": [
              ...
              {
                "code": "1",
                "display": "Er mer sliten enn vanlig, men er for det meste oppe"
              },
              {
                "code": "2",
                "display": "Trenger mye hvile, men er oppe innimellom"
              },
              {
                "code": "3",
                "display": "Er sengeliggende og trenger noe hjelp"
              },
              {
                "code": "4",
                "display": "Er sengeliggende og trenger hjelp til det meste"
              }
            ]
          }
        ]
        ...
        "include": [
          {
            ...
            "concept": [
              ...
              {
                "code": "3",
                "display": "Lungesykdom (gjelder ikke mild eller velbehandlet astma)"
              },
              {
                "code": "4",
                "display": "Kreft"
        ...
        "include": [
          {
            ...
            "concept": [
              ...
              {
                "code": "3",
                "display": "Hjemme grunnet stengt barnehage/skole"
              },
              {
                "code": "4",
              ...
              {
                "code": "99",
                "display": "Ingen av disse utsagnene passer for meg"
              }
            ]
          }
        ]
  ...
  "extension": [
    {
      ...
      "valueReference": {
        "reference": "https://skjemakatalog-test-fhir-apimgmt.azure-api.net/api/v1/Endpoint/32"
      }
    },
    {
    ...
    {
      "url": "http://ehelse.no/fhir/StructureDefinition/sdf-generatenarrative",
      "valueBoolean": false
    },
    {
  ...
  "url": "https://skjemakatalog-prod-fhir-apimgmt.azure-api.net/api/v1/Questionnaire/302",
  "version": "0.6",
  ...
  "date": "2020-03-23",
  "publisher": "NHN",
  "description": "Dette skjemaet skal kun benyttes for selvapportering til myndighetene, slik at de får bedre oversikt over mennesker i befolkningen som kan ha, eller har vært utsatt for Koronasmitte.",
  "useContext": [
    {
      "code": {
        ...
        "coding": [
          {
            ...
            "code": "29",
            "display": "Innrapportering av symptomer på korona til FHI"
          }
        ]
      }
    }
  ...
  "item": [
    {
      ...
      "item": [
        {
          "linkId": "1.100",
          "text": "Dette skjemaet er for deg som i løpet av de siste syv dagene har fått symptomer som kan skyldes koronavirus. Her kan du melde til Folkehelseinstituttet slik at helsemyndighetene får bedre oversikt over utbredelsen av smitte.",
          "_text": {
            "extension": [
              {
                "url": "http://hl7.org/fhir/StructureDefinition/rendering-markdown",
                "valueMarkdown": "Dette skjemaet er for deg som i løpet av de siste syv dagene har fått symptomer som kan skyldes koronavirus.\r\n\r\nHer kan du melde til Folkehelseinstituttet slik at helsemyndighetene får bedre oversikt over utbredelsen av smitte."
              }
            ]
          },
          "type": "display"
          ...
          "extension": [
            {
              ...
              "valueString": "Patient.identifier.where(use = 'official' and system = 'urn:oid:2.16.578.1.12.4.1.4.1').value"
            }
          ],
          "linkId": "2.100",
          "text": "Fødselsnummer",
      ...
      "item": [
        {
          ...
          "linkId": "5.100",
          "text": "Har du i løpet av de siste syv dagene fått symptomer som kan skyldes koronavirus?",
          "type": "choice",
          "required": true,
          "repeats": false,
          "readOnly": false,
        ...
        },
        {
          ...
          "_text": {
            "extension": [
              {
                "url": "http://hl7.org/fhir/StructureDefinition/rendering-markdown",
                "valueMarkdown": "#### Hvilke symptomer har du hatt?\r\nDu kan velge én eller flere"
              }
            ]
          },
          "type": "choice",
        ...
        },
        {
          "extension": [
            {
              "url": "http://ehelse.no/fhir/StructureDefinition/validationtext",
              "valueString": "Du kan velge en dato fra i dag og 7 dager tilbake i tid. Dato skal ha format dd.mm.åååå."
            },
            {
              "url": "http://ehelse.no/fhir/StructureDefinition/sdf-fhirpathvalidation",
              "valueString": "this.value <= today()  and this.value >=today() - 7 days"
            },
            {
          ...
          "_text": {
            "extension": [
              {
                "url": "http://hl7.org/fhir/StructureDefinition/rendering-markdown",
                "valueMarkdown": "#### Hvilken dag fikk du symptomer?\r\nDato skal ha format dd.mm.åååå"
              }
            ]
          },
          "type": "date",
        ...
        },
        {
          ...
          "linkId": "5.401",
          "text": "Hak av om du får behandling for noen av disse sykdommene",
          "_text": {
            "extension": [
              {
                "url": "http://hl7.org/fhir/StructureDefinition/rendering-markdown",
                "valueMarkdown": "#### Hak av om du får behandling for noen av disse sykdommene\r\nDu kan velge flere, én eller ingen"
              }
            ]
          },
          "type": "choice",
        ...
        },
        {
          ...
          "linkId": "5.500",
          "text": "Har du vært i kontakt med lege eller legevakt på grunn av symptomene dine?",
          "type": "choice",
          "enableWhen": [
            {
              "question": "5.100",
        ...
        },
        {
          ...
          "linkId": "5.600",
          "text": "Har du blitt testet for koronavirus i løpet av denne sykdomsperioden?",
          "type": "choice",
          "enableWhen": [
            {
              "question": "5.100",
      ...
      "item": [
        ...
        },
        {
          "extension": [
            {
              "url": "http://ehelse.no/fhir/StructureDefinition/validationtext",
              "valueString": "Du må hake av her for å gi ditt samtykke og sende inn skjemaet, eller velge avbryt"
            }
          ],
          "linkId": "10.300",
          "text": "Jeg samtykker til at opplysningene jeg har gitt, kan brukes i samsvar med ovennevnte.",
          "type": "boolean",
          "required": true,
          "repeats": false,
          "readOnly": false
