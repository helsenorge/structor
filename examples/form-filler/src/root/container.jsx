...
const getResources = (language) => {
    ...
    if (language === 'fr-FR') {
        return {
            ...
            selectDefaultPlaceholder: 'Séléctionnez une des options.',
            ...
            oppgiVerdi: 'Séléctionnez une des options.',
            oppgiGyldigVerdi: 'Merci de rentrer une valeur valide',
            formCancel: 'Annuler',
            formSend: 'Valider',
            ...
            filterDateCalendarButton: 'Selectionner une date',
            ...
            stringOverMaxLengthError: 'Vous avez rentré trop de caractères. Réduisez le texte.',
            ...
            returnFocusToInput: 'Retourner dans à la date saisie',
            ...
            yearmonth_field_invalid_year: 'Vous devez rentrer une année valide',
